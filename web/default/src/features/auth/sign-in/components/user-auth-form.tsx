  ...
  return (
    <Form {...form}>
      ...
      >
            ...
            <FormItem>
              ...
              <FormControl>
                <Input
                  ...
                  className="h-12 rounded-xl border-0 bg-white/60 backdrop-blur-sm transition-all focus:bg-white/80 focus:ring-2 focus:ring-cyan-400/50"
                  style={{
                    boxShadow:
                      "0 1px 2px 0 rgba(255, 255, 255, 1) inset, 0 4px 16px rgba(0, 0, 0, 0.06)",
                  }}
                  {...field}
                />
              </FormControl>
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem className="relative">
              ...
              <Link
                to="/forgot-password"
                className="absolute end-0 -top-0.5 text-sm font-medium transition-opacity hover:opacity-75"
                style={{
                  background:
        ...
        <Button
          type="submit"
          className="mt-2 h-12 w-full justify-center gap-2 rounded-xl font-semibold text-white transition-all hover:opacity-90"
          style={{
            background:
              "linear-gradient(135deg, #00b4d8 0%, #8b5cf6 50%, #f72585 100%)",
            boxShadow:
              "0 4px 20px rgba(139, 92, 246, 0.4), 0 2px 8px rgba(0, 180, 216, 0.3)",
          }}
        ...
        {passkeyLoginEnabled && (
          <div className="mt-2 space-y-1">
            <Button
              ...
              className="h-12 w-full justify-center gap-2 rounded-xl border-0 font-semibold transition-all hover:opacity-90"
              style={{
                background:
                ...
                boxShadow:
                  "0 1px 2px 0 rgba(255, 255, 255, 1) inset, 0 6px 24px rgba(0, 0, 0, 0.08)",
